import{i as N,e as G,r as q,a as O,x as c,C as M,A as z,O as ee,b as j,E as te,R as U,c as Me,d as K,f as k,S as ft,g as Ci,W as pt,h as Zt,j as yn,T as en,k as Xe,M as oi,l as ri,m as Ne,n as xn,o as Ri}from"./ZmEDVhFy.js";import{n as u,c as P,o as E,r as _,U as he,e as $i,f as _i,a as Ii}from"./pYkzmljC.js";import{d2 as Ei}from"./48rv0pLh.js";import"./mOzlqLiW.js";import"./DpYZypXW.js";import"./DLxfOvk0.js";(function(){try{var r=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},e=new r.Error().stack;e&&(r._sentryDebugIds=r._sentryDebugIds||{},r._sentryDebugIds[e]="02461668-84ca-4451-9dae-b264f4d645f2",r._sentryDebugIdIdentifier="sentry-dbid-02461668-84ca-4451-9dae-b264f4d645f2")}catch{}})();const Wi=N`
  :host {
    position: relative;
...
`;var Y=function(r,e,n,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(r,e,n,i);else for(var s=r.length-1;s>=0;s--)(a=r[s])&&(t=(o<3?a(t):o>3?a(e,n,t):a(e,n))||t);return o>3&&t&&Object.defineProperty(e,n,t),t};let F=class extends O{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.tabIdx=void 0,this.installed=!1,this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return c`
    ...
    `}onConnector(e){M.setActiveConnector(e),U.push("ConnectingWalletConnect")}};mt([u()],Ve.prototype,"tabIdx",void 0);mt([_()],Ve.prototype,"connectors",void 0);mt([_()],Ve.prototype,"connectorImages",void 0);Ve=mt([P("w3m-connect-walletconnect-widget")],Ve);const Bi=N`
  :host {
...
`;return typeof s=="function"&&s(null,S),S},Jt}var Zn;function ho(){if(Zn)return Te;Zn=1;const r=Fi(),e=lo(),n=co(),i=uo();function o(t,a,s,l,d){const h=[].slice.call(arguments,1),w=h.length,x=typeof h[w-1]=="function";if(!x&&!r())throw new Error("Callback required as last argument");if(x){if(w<2)throw new Error("Too few arguments provided");w===2?(d=s,s=a,a=l=void 0):w===3&&(a.getContext&&typeof d>"u"?(d=l,l=void 0):(d=l,l=s,s=a,a=void 0))}else{if(w<1)throw new Error("Too few arguments provided");return w===1?(s=a,a=l=void 0):w===2&&!a.getContext&&(l=s,s=a,a=void 0),new Promise(function(p,W){try{const v=e.create(s,l);p(t(v,a,l))}catch(v){W(v)}})}try{const p=e.create(s,l);d(null,t(p,a,l))}catch(p){d(p)}}return Te.create=e.create,Te.toCanvas=o.bind(null,n.render),Te.toDataURL=o.bind(null,n.renderToDataURL),Te.toString=o.bind(null,function(t,a,s){return i.render(t,s)}),Te}var fo=ho();const po=Ei(fo),go=.1,ei=2.5,de=7;function Qt(r,e,n){return r===e?!1:(r-e<0?e-r:r-e)<=n+go}function wo(r,e){const n=Array.prototype.slice.call(po.create(r,{errorCorrectionLevel:e}).modules.data,0),i=Math.sqrt(n.length);return n.reduce((o,t,a)=>(a%i===0?o.push([t]):o[o.length-1].push(t))&&o,[])}const bo={generate({uri:r,size:e,logoSize:n,dotColor:i="#141414"}){const o="transparent",a=[],s=wo(r,"Q"),l=e/s.length,d=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];d.forEach(({x:v,y:S})=>{const b=(s.length-de)*l*v,g=(s.length-de)*l*S,m=.45;for(let f=0;f<d.length;f+=1){const D=l*(de-f*2);a.push(Ne`
            ...
            />
          `)}});const h=Math.floor((n+25)/l),w=s.length/2-h/2,x=s.length/2+h/2-1,p=[];s.forEach((v,S)=>{v.forEach((b,g)=>{if(s[S][g]&&!(S<de&&g<de||S>s.length-(de+1)&&g<de||S<de&&g>s.length-(de+1))&&!(S>w&&S<x&&g>w&&g<x)){const m=S*l+l/2,f=g*l+l/2;p.push([m,f])}})});const W={};return p.forEach(([v,S])=>{W[v]?W[v]?.push(S):W[v]=[S]}),Object.entries(W).map(([v,S])=>{const b=S.filter(g=>S.every(m=>!Qt(g,m,l)));return[Number(v),b]}).forEach(([v,S])=>{S.forEach(b=>{a.push(Ne`<circle cx=${v} cy=${b} fill=${i} r=${l/ei} />`)})}),Object.entries(W).filter(([v,S])=>S.length>1).map(([v,S])=>{const b=S.filter(g=>S.some(m=>Qt(g,m,l)));return[Number(v),b]}).map(([v,S])=>{S.sort((g,m)=>g<m?-1:1);const b=[];for(const g of S){const m=b.find(f=>f.some(D=>Qt(g,D,l)));m?m.push(g):b.push([g])}return[v,b.map(g=>[g[0],g[g.length-1]])]}).forEach(([v,S])=>{S.forEach(([b,g])=>{a.push(Ne`
              <line
                x1=${v}
                x2=${v}
                y1=${b}
...
`;var bi=function(r,e,n,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(r,e,n,i);else for(var s=r.length-1;s>=0;s--)(a=r[s])&&(t=(o<3?a(t):o>3?a(e,n,t):a(e,n))||t);return o>3&&t&&Object.defineProperty(e,n,t),t};let ut=class extends O{constructor(){super(...arguments),this.icon="copy"}render(){return c`
    ...
    `}};ut.styles=[q,G,To];bi([u()],ut.prototype,"icon",void 0);ut=bi([P("wui-input-element")],ut);const Bo=N`
  :host {
    position: relative;
    width: 100%;
    display: inline-block;
...
`;var mi=function(r,e,n,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(r,e,n,i);else for(var s=r.length-1;s>=0;s--)(a=r[s])&&(t=(o<3?a(t):o>3?a(e,n,t):a(e,n))||t);return o>3&&t&&Object.defineProperty(e,n,t),t};let dt=class extends O{constructor(){super(...arguments),this.type="wallet"}render(){return c`
    ...
    `}shimmerTemplate(){return this.type==="network"?c` <wui-shimmer
          ...
          borderRadius="xs"
        ></wui-shimmer>
        ${Oo}`:c`<wui-shimmer width="56px" height="56px" borderRadius="xs"></wui-shimmer>`}};dt.styles=[q,G,Ao];mi([u()],dt.prototype,"type",void 0);dt=mi([P("wui-card-select-loader")],dt);const jo=N`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
